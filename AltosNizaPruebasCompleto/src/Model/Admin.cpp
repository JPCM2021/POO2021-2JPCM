...
int Admin::mostrarBeneficios(int id){
    string beneficios[2];

    beneficios[0] = "1. Derecho a usar el salón social de manera gratuita.";
    beneficios[1] = "2. Descuento del 1 para la compra de productos en la tienda del edificio.";
